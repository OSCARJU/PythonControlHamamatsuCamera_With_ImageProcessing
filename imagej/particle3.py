...
path_to_imagej_macro = "C:/Users/USER/Desktop/image/particle_counting.ijm"
dir_prefix = "C:/Users/USER/Desktop/"
...
def resolve_particles(file_name, path_to_imagej_macro):
    ...
    command = "imagej '" + path_to_imagej_macro + "' '" + file_name + "'"
    #command = "F:/NATIONAL TAIPEI UNIVERSITY OF TECHNOLOGY/ij153-win-java8/ImageJ/ImageJ  '"  + path_to_imagej_macro + "' '" + file_name + "'"
...
for n, dir_name in enumerate(dir_names):
    ...
    print
    "\tTotal particles fitted with ellipse: ", len(major)
    print
    "\tMajor avg, sigma: ", major_average, major_sigma
    print
    "\tMinor avg, sigma: ", minor_average, minor_sigma
