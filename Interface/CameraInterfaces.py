...
class PreviewHamamatsu(BaseHamamatsu, BasePreview):
    def __init__(self, **kwargs):
        ...
        self.PlotExtraWindow = kwargs['PlotExtraWindow']
        ##background SETTINGS
        self.minPixelStabilityCNT = kwargs['minPixelStabilityCNT']
        self.maxPixelStabilityCNT= kwargs['maxPixelStabilityCNT']
        self.useHistoryCNT = kwargs['useHistoryCNT']
        self.isParallelCNT= kwargs['isParallelCNT']
        # BGK GMG
        self.initializationFramesGMG = kwargs['initializationFramesGMG']
        self.decisionThresholdGMG = kwargs['decisionThresholdGMG']
        # BGK GSOC
        self.nSamplesGSOC = kwargs['nSamplesGSOC']
        self.replaceRateGSOC = kwargs['replaceRateGSOC']
        self.propagationRateGSOC = kwargs['propagationRateGSOC']
        self.hitsThresholdGSOC = kwargs['hitsThresholdGSOC']
        self.alphaGSOC = kwargs['alphaGSOC']
        self.betaGSOC = kwargs['betaGSOC']
        # BGK KNN
        self.historyKNN = kwargs['historyKNN']
        self.dist2ThresholdKNN = kwargs['dist2ThresholdKNN']
        self.detectShadowsKNN = kwargs['detectShadowsKNN']
        # BKG LSBP
        self.nSamplesLSBP = kwargs['nSamplesLSBP']
        self.LSBPRadius = kwargs['LSBPRadius']
        self.TupperLSBP = kwargs['TupperLSBP']
        self.RscaleLSBP = kwargs['RscaleLSBP']
        self.LSBPthreshold = kwargs['LSBPthreshold']
        self.minCountLSBP = kwargs['minCountLSBP']
        # BKG MOG
        self.historyMOG = kwargs['historyMOG']
        self.nmixturesMOG = kwargs['nmixturesMOG']
        self.backgroundRatioMOG = kwargs['backgroundRatioMOG']
        self.noiseSigmaMOG = kwargs['noiseSigmaMOG']
        # BKG MOG2
        self.historyMOG2 = kwargs['historyMOG2']
        self.varThresholdMOG2 = kwargs['varThresholdMOG2']
        self.detectShadowsMOG2 = kwargs['detectShadowsMOG2']
        # BKG RNB
        self.alphaRNB = kwargs['alphaRNB']
        self.ThuRNB = kwargs['ThuRNB']
        self.ThsRNB = kwargs['ThsRNB']
        # BKG FZBL
        self.alphaFZBL = kwargs['alphaFZBL']
        self.ThsFZBL = kwargs['ThsFZBL']
        self.ThfsFZBL = kwargs['ThfsFZBL']
        # BKG FZB
        self.alphaFZB = kwargs['alphaFZB']
        self.alphaMinFZB = kwargs['alphaMinFZB']
        self.ThsFZB = kwargs['ThsFZB']
        self.ThfsFZB = kwargs['ThfsFZB']
        # Image Img Subtractor
        self.alphaSUB = kwargs['alphaSUB']
        self.bethaSUB = kwargs['bethaSUB']
        self.constantSUB = kwargs['constantSUB']
        # Image Lapse
        self.alphaLapse = kwargs['alphaLapse']
        self.bethaLapse = kwargs['bethaLapse']
        self.constantLapse = kwargs['constantLapse']
    ...
    def run(self):
        ...
        while self._show_preview:
            try:
                ...
                self.iv.setImage(img, autoRange=False, autoLevels=False, autoHistogramRange=False)
                ## here release memory
                frames2realease = frames2realease + 1
                #release and restar the image visualization
                if (frames2realease == 1000):
                    frames2realease = 0
                    self.hcam.stopAcquisition()
                    self.hcam.startAcquisition()
        ...
        if (BGKimage == 2):
            ...
            if (Dimage == 4):
                ...
                img = cv2.addWeighted(self.fgbg.getBackgroundImage(), self.alphaSUB,
                                      (np.where(bmg > self.fgbg.getBackgroundImage(), inputImage, 0)), self.bethaSUB,
                                      self.constantSUB)
        if (BGKimage == 3):
            if (Dimage == 1):
                img = inputImage
        ...
        if (BGKimage == 5):
            ...
            if (Dimage == 4):
                ...
                img = cv2.addWeighted(self.fgbgKNN.getBackgroundImage(), self.alphaSUB,
                                      (np.where(bmg > self.fgbgKNN.getBackgroundImage(), inputImage, 0)), self.bethaSUB,
                                      self.constantSUB)
        ...
        if (BGKimage == 8):
            ...
            if (Dimage == 4):
                ...
                img = cv2.addWeighted(self.fgbgMOG2.getBackgroundImage(), self.alphaSUB,
                                      (np.where(bmg > self.fgbgMOG2.getBackgroundImage(), inputImage, 0)),
                                      self.bethaSUB, self.constantSUB)
        return img
...
class WriterHamamatsu(BaseWriter, BasePreview):
    ...
    def __init__(self, threading_queue, filename, compression_level, levels, metadata):
        ...
        ##background SETTINGS
        self.minPixelStabilityCNT = self.metadata['minPixelStabilityCNT']
        self.maxPixelStabilityCNT = self.metadata['maxPixelStabilityCNT']
        self.useHistoryCNT = self.metadata['useHistoryCNT']
        self.isParallelCNT = self.metadata['isParallelCNT']
        # BGK GMG
        self.initializationFramesGMG = self.metadata['initializationFramesGMG']
        self.decisionThresholdGMG = self.metadata['decisionThresholdGMG']
        # BGK GSOC
        self.nSamplesGSOC = self.metadata['nSamplesGSOC']
        self.replaceRateGSOC = self.metadata['replaceRateGSOC']
        self.propagationRateGSOC = self.metadata['propagationRateGSOC']
        self.hitsThresholdGSOC = self.metadata['hitsThresholdGSOC']
        self.alphaGSOC = self.metadata['alphaGSOC']
        self.betaGSOC = self.metadata['betaGSOC']
        # BGK KNN
        self.historyKNN = self.metadata['historyKNN']
        self.dist2ThresholdKNN = self.metadata['dist2ThresholdKNN']
        self.detectShadowsKNN = self.metadata['detectShadowsKNN']
        # BKG LSBP
        self.nSamplesLSBP = self.metadata['nSamplesLSBP']
        self.LSBPRadius = self.metadata['LSBPRadius']
        self.TupperLSBP = self.metadata['TupperLSBP']
        self.RscaleLSBP = self.metadata['RscaleLSBP']
        self.LSBPthreshold = self.metadata['LSBPthreshold']
        self.minCountLSBP = self.metadata['minCountLSBP']
        # BKG MOG
        self.historyMOG = self.metadata['historyMOG']
        self.nmixturesMOG = self.metadata['nmixturesMOG']
        self.backgroundRatioMOG = self.metadata['backgroundRatioMOG']
        self.noiseSigmaMOG = self.metadata['noiseSigmaMOG']
        # BKG MOG2
        self.historyMOG2 = self.metadata['historyMOG2']
        self.varThresholdMOG2 = self.metadata['varThresholdMOG2']
        self.detectShadowsMOG2 = self.metadata['detectShadowsMOG2']
        # BKG RNB
        self.alphaRNB = self.metadata['alphaRNB']
        self.ThuRNB = self.metadata['ThuRNB']
        self.ThsRNB = self.metadata['ThsRNB']
        # BKG FZBL
        self.alphaFZBL = self.metadata['alphaFZBL']
        self.ThsFZBL = self.metadata['ThsFZBL']
        self.ThfsFZBL = self.metadata['ThfsFZBL']
        # BKG FZB
        self.alphaFZB = self.metadata['alphaFZB']
        self.alphaMinFZB = self.metadata['alphaMinFZB']
        self.ThsFZB = self.metadata['ThsFZB']
        self.ThfsFZB = self.metadata['ThfsFZB']
        # Image Img Subtractor
        self.alphaSUB = self.metadata['alphaSUB']
        self.bethaSUB = self.metadata['bethaSUB']
        self.constantSUB = self.metadata['constantSUB']
        # Image Lapse
        self.alphaLapse = self.metadata['alphaLapse']
        self.bethaLapse = self.metadata['bethaLapse']
        self.constantLapse = self.metadata['constantLapse']
