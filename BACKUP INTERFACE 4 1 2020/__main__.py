...
#FUNCTION TO READ PARAMETERS
    ...
    def PlayVideo(self):
        ...
        if True:
            ...
            while endVideo:
                ...
                if self.ui.TWImageV.currentIndex() == 0:
                    self.ui.GVImage.show()
                    self.ui.GVImage.setImage(img)
                if self.ui.TWImageV.currentIndex() == 1:
                    self.ui.TWImageA.show()
                    self.ui.TWImageA.setImage(img)
                    self.ui.TWImageB.show()
                    self.ui.TWImageB.setImage(SUBimg)
                    self.ui.TWImageC.show()
                    self.ui.TWImageC.setImage(FRGimg)
                    self.ui.TWImageD.show()
                    self.ui.TWImageD.setImage(BGKimg)
                if self.ui.CBHist.isChecked() == False:
                    self.ui.GVImage.ui.histogram.hide()
                    self.ui.TWImageA.ui.histogram.hide()
                    self.ui.TWImageB.ui.histogram.hide()
        ...
        if (BGKimage == 5):
            ...
            if (Dimage == 4):
                ...
                img = cv2.addWeighted(self.fgbgKNN.getBackgroundImage(), 0.25,
                                      (np.where(bmg > self.fgbgKNN.getBackgroundImage(), inputImage, 0)), 0.75,
                                      0)
        ...
        if (BGKimage == 8):
            ...
            if (Dimage == 4):
                ...
                img = cv2.addWeighted(self.fgbgMOG2.getBackgroundImage(), 0.25,
                                      (np.where(bmg > self.fgbgMOG2.getBackgroundImage(), inputImage, 0)), 0.75,
                                      0)
        return img
    ...
    def Plot_Frame(self):
        ...
        if FramefilePath.endswith('.tiff' or '.png' or '.jpg' or '.tif'):
...
##FUNCTIONS TO PLOT IMAGE
    ...
    def acquire_slot(self, ev):
        if (self.ui.PBAcquire.text()=='Acquire'):
            ...
            self.ui.LEPATH.setText(self.ui.LEFileP.text())
